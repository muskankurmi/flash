...
<body>
	...
	<div id="mySidenav" class="sidenav">
		...
		<div class="dropdown-container">
			<a  class="active"href="stock.jsp">Add in Stock</a> 
			...
			<div class="container">
				<div class="row">
					<div class="container">
						...
						<form class="well form-horizontal" action="StockCheck"
							...
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-4 inputGroupContainer">
										<div class="input-group">
											<span class="input-group-addon"></span> <input name="status"
												placeholder="in stock/ out of stock" class="form-control"
												type="text">
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-4 inputGroupContainer">
										<div class="input-group">
											<span class="input-group-addon"></span> <input
												name="strength" placeholder="strength of medicine"
												class="form-control" type="text">
										</div>
									</div>
								</div>
									...
									<div class="col-md-4 inputGroupContainer">
										<div class="input-group">
											<span class="input-group-addon"></span> <input name="vendor"
												placeholder="manufacturing date of medicine"
												class="form-control" type="text">
										</div>
									</div>
								</div>
									...
									<div class="col-md-4 inputGroupContainer">
										<div class="input-group">
											<span class="input-group-addon"></span> <input name="price"
												placeholder="prize of medicine" class="form-control"
												type="text">
										</div>
									</div>
								</div>
