...
<body>
	...
	<div id="mySidenav" class="sidenav">
		...
		<div class="dropdown-container">
			<a class="active" href="invoice.jsp">Customer billing</a>
			...
			<div class="container">
				<div class="row">
					<div class="container">
						...
						<form class="well form-horizontal" action="InvoiceCheck"
							...
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-4 inputGroupContainer">
										<div class="input-group">
											<span class="input-group-addon"></span> <input name="batch_no"
												placeholder="batch_no." class="form-control" type="text">
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-4 inputGroupContainer">
										<div class="input-group">
											<span class="input-group-addon"></span> <input name="payment_method"
												placeholder="payment_method" class="form-control" type="text">
										</div>
									</div>
								</div>

								<div class="form-group">
									<label class="col-md-4 control-label">Item/Medicine name</label>
									<div class="col-md-4 inputGroupContainer">
										<div class="input-group">
											<span class="input-group-addon"></span> <input name="item"
												placeholder="item" class="form-control" type="text">
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-4 inputGroupContainer">
										<div class="input-group">
											<span class="input-group-addon"></span> <input name="expiry_date"
												placeholder="expiry_date" class="form-control" type="text">
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-4 inputGroupContainer">
										<div class="input-group">
											<span class="input-group-addon"></span> <input name=""quantity
								...
								<div class="form-group">
									...
									<div class="col-md-4 inputGroupContainer">
										<div class="input-group">
											<span class="input-group-addon"></span> <input name="gst"
												placeholder="gst" class="form-control" type="text">
										</div>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label class="col-md-4 control-label">Final_amount</label>
									<div class="col-md-4 inputGroupContainer">
										<div class="input-group">
											<span class="input-group-addon"></span> <input name="final_amount"
												placeholder="final_amount" class="form-control" type="text">
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-4 inputGroupContainer">
										<div class="input-group">
											<span class="input-group-addon"></span> <input name="total"
												placeholder="total" class="form-control" type="text">
										</div>
									</div>
								</div>
