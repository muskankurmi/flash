...
<body>
	...
	<div id="mySidenav" class="sidenav">
		...
		<a class="active" href="purchaseBill.jsp">Purchasing bill</a>
	    <a href="showPurchaseBilling.jsp">View Purchase bills</a> 
			...
			<div class="container">
				<div class="row">
					<div class="container">
						...
						<form class="well form-horizontal" action="PurchaseCheck"
							...
							<fieldset>
									...
									<div class="col-md-4 inputGroupContainer">
										<div class="input-group">
											<span class="input-group-addon"></span> <input name="date"
												placeholder="date" class="form-control" type="text">
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-4 inputGroupContainer">
										<div class="input-group">
											<span class="input-group-addon"></span> <input name="vendor"
												placeholder="vendor of medicine" class="form-control"
												type="text">
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-4 inputGroupContainer">
										<div class="input-group">
											<span class="input-group-addon"></span> <input name="paid"
												placeholder="paid amount" class="form-control" type="text">
										</div>
									</div>
								</div>

								<div class="form-group">
									<label class="col-md-4 control-label">UnPaid Amount</label>
									<div class="col-md-4 inputGroupContainer">
										<div class="input-group">
											<span class="input-group-addon"></span> <input name="unpaid"
												placeholder="unpaid amount" class="form-control" type="text">
										</div>
									</div>
								</div>
