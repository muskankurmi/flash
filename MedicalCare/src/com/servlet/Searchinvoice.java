...
public class Searchinvoice extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String query = "select * from medicalshop.bill";
			if (batch_no != null && !batch_no.equals("")) {
				query = "select * from medicalshop.bill where batch_no='" + batch_no + "' ";
			}
			...
			RequestDispatcher view = request.getRequestDispatcher("viewSearchnvce.jsp");
